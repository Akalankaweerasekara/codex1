                                ...
                                <form action="" method="POST">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="bname" value=""  placeholder="Insert Brand Name">
                                        </div>
...
if (isset($_POST['save'])) {
    ...
    $queryss = "insert into brands(brand_title)values('$bname')";
    if (mysqli_query($con, $queryss)) {
        echo "<script>alert('Brand Saved')</script>";
    } else {
        echo "<script>alert('Brand Not Saved')</script>";
    }
}
?>
