...
<body class="hold-transition login-page" style="background: skyblue;">
<div class="login-box">
  <div class="login-logo">
    <a href=""><b>WingsMartz</b>&nbsp; Admin</a>
  </div>
  <!-- /.login-logo -->
    ...
    <form action="" method="post">
      ...
      <div class="row">
        ...
        <div class="col-xs-12" align="center">
            <button type="submit" name="logd" class="btn btn-primary btn-block btn-flat">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
