...
<html>
    <head>
        ...
        <title>Wingsmartz | Categories</title>
                                ...
                                <form action="" method="POST">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="cname" value=""  placeholder="Insert Category Name">
                                        </div>
...
if (isset($_POST['save'])) {
    ...
    $queryss = "insert into categories(cat_title)values('$cname')";
    if (mysqli_query($con, $queryss)) {
        echo "<script>alert('Category Saved')</script>";
    } else {
        echo "<script>alert('Category Not Saved')</script>";
    }
}
?>
