 ...
 <?php
        ...
        if ($sres) {
            if (mysqli_num_rows($sres)) {
                ...
                echo "<script>alert('No Blog Available')</script>";
        }}
                                ...
                                <form action="" method="POST">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="bid" value="<?php echo $blid;  ?>"  placeholder="Auto Generated">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Blog Header</label>
                                            <input type="text" class="form-control" name="bhd" value="<?php echo $blhd;  ?>"  placeholder="Enter Blog Header">
                                        </div>
                                        
                                        
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Blog Title</label>
                                            <input type="text" name="btt" class="form-control" value="<?php echo $bltt;  ?>"  placeholder="Enter Title">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Blog Quotes</label>
                                            <input type="text" name="bqt" class="form-control" value="<?php echo $blqt;  ?>"  placeholder="Enter Quotes">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"> Blog Image</label>
                                            <input type="text" name="bimg" class="form-control" value="<?php echo $blimg;  ?>"  placeholder="Enter Blog Image">
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputEmail1">First Content</label>
                                            <input type="text" name="bft" class="form-control" value="<?php echo $blft;  ?>"  placeholder="Enter First Content">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Second Content</label>
                                            <input type="text" name="bst" class="form-control" value="<?php echo $blst;  ?>"  placeholder="Enter Second Content">
                                        </div>
...
if (isset($_POST['upd'])) {
    ...
    $queryss = "update blog set ahead='$bhd',htitle='$btt',qotes='$bqt',img='$bimg',fcontent='$bft',scontent='$bst'";
    if (mysqli_query($con, $queryss)) {
        //echo "<script>alert('Blog Updated')</script>";
        echo "<script>document.location='iblog.php'</script>";
