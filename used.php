...
<head>
  ...
  <meta name="description" content="Wingsmartz sale">
...
<body>
  <section class="menu cid-s9yfOLE25T" once="menu" id="menu1-w">
...
<section class="engine"><a href="">wingsmartz</a></section><section class="mbr-section form3 cid-s9P4y8XyBz mbr-parallax-background" id="form3-x">
...
<section class="services1 cid-s9P4KZCcRa" id="services1-y">
    <!---->
             ...
             function getproductz() {
                        ...
                        if (!isset($_GET['cat'])) {
                            if (!isset($_GET['brand'])) {
                                ...
                                $query = "select * from products where ptp='used' order by RAND()";
...
<section class="cid-s9PEbMRWZl" id="footer1-23">
